...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            resource_store::upsert_project,
            resource_store::list_projects,
            ...
            resource_store::get_skill_library_summary,
            resource_store::list_skill_library_items,
            resource_store::get_skill_detail,
            resource_store::get_mcp_library_summary,
            resource_store::list_mcp_service_items,
            resource_store::get_mcp_service_detail,
